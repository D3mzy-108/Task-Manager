...
#     return render(request, 'task_manager/addtask.html', context)


# def task_details(request, id=id):
...
#     return render(request, 'task_manager/task_details.html', context)
...
#     return render(request, 'task_manager/updatetask.html', context)
